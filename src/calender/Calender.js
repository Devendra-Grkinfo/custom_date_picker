...
const [decadeStart,setDecadeStart] =useState( Math.floor(year/ 10) * 10)
  return (
    ...
    <Header currentDate={currentDate}  setCurrentDate={setCurrentDate} decadeStart={decadeStart} setDecadeStart={setDecadeStart}   render={render} setRender={setRender}  dateFormat={dateFormat} setDateFormat={setDateFormat} selectedDate={selectedDate} setSelectedDate={setSelectedDate} />
    {render=== 1 && <>
    ...
    { render===3 &&<>
      <YearInterval currentDate={currentDate} month={month} decadeStart={decadeStart} year={year} setYear={setYear}  selectedDate={selectedDate} setCurrentDate={setCurrentDate}/>
    </>
    }
    </div>
  );
